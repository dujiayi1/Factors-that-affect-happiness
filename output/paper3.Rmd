...
ggplot(gss,aes(x=feelings_life,fill=income_respondent))+geom_bar(position = "dodge",binwidth = 1)+facet_grid(.~marital_status)+ylab("number of people")+xlab("feelings about life")+scale_fill_discrete(name = "respondent income")+theme_minimal()
```

## Average weekly working hours

Figure \@ref(fig:figure4) demonstrates the relationship between feelings about life and the weekly average working hours of respondents. It's not surprising to find that people with less working hours tend to have more points of feeling about life, which is much more apparent for married groups. It seems that people with 6-8 working hours every day may be happier about life.
...
ggplot(gss,aes(x=feelings_life,fill=average_hours_worked))+geom_histogram(position = "dodge",binwidth = 1)+facet_grid(.~marital_status)+ylab("number of people")+xlab("feelings about life")+scale_fill_discrete(name = "working hours")+theme_minimal()
...
ggplot(gss,aes(x=feelings_life,fill=education))+geom_histogram(position = "dodge",binwidth = 1)+facet_grid(.~marital_status)+ylab("number of people")+xlab("feelings about life")+scale_fill_discrete(name = "education level")+theme_minimal()
