...
Table \@ref(tab:dataextract) shows the first ten rows of the GSS Family dataset of interest .Variable “Age” indicates the age group of the survey respondents. Variable “Feelings about life” indicates how the respondents generally feel about their life from a scale of 0 to 10. Variable “Sex” indicates indicates the sexuality of the respondents. Variable “Marital Status” gives information on whether the respondents are single, living common-law, married, separated, divorced, or widowed; in this paper, we are only interested in the respondents who are either single or married. Variable "Average hours worked" shows the weekly working hours of the respondents. Variable “Personal income” indicates the personal income of the respondents from all possible sources.
